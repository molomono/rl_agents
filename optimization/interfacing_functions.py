...
def return_reward(return_all_trials = False, normalize=False):
    ...
    :param return_all_trials: boolean, Defines wether to return a list of all trials run, if false only the final entry is returned.
    :param normalize: boolean, defines wether to divide the total performance by the number of episodes run.
    
    :returns: (list of) floats representing the total performance for a training epoch.
    '''
...
def run_ai(param_list):
    ...
    :param param_list: List of hyper-parameters
...
def remove_failed_optimization_iteration(remove_param = True, remove_log_arg = False):
    ...
    :param remove_param: boolean, Defines if the last hyper-parameter entery should be removed from the log file.
    :param remove_log_arg: boolean, Defines if the last training epoch log file should be removed.
    '''
    num_iterations = 0
    if remove_param:
        #Load parameters.csv 
